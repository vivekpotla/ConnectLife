...
OPENAI_KEY = "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"


def OpenAIChatCompletion(question):
    template = """
    YOU ARE A OFFICIAL CHATBOT FOR A BLOOD DONATION AUTOMATION SYSTEM. YOUR WORK IS TO HELP THE DONORS THROUGH THE WEBSITE,
